...
% Rinderpest is eliminated \citep{Roeder2011}, rabies is reduced \citep{Freuling2013}, and management strategies are being implemented in a number of other wildlife systems [CWD, Koala STDs, etc.]. 

% OUTLINE OF INTRO

% Two major challenges that we are addressing in this paper
% 1. A "new" approach for modeling macroparasites (sorta)
% - This is addressing the knowledge gap of how do we model host-macroparasite systems
% 2. Parameter estimation in a host-macroparasite system
% - The knowledge gap is that we don't have great data so how do we leverage this data to learn about transmission and 
% 3. Using models to manage host-parasite systems.
%      - McCaallum identifies a need to develop models to identify best management strategies for macroparasites
%   - Application to raccoon roundworm


% Paragraph 1
% -----------
% Begin by discussing how models have been used in disease systems to manage host parasite systems.
...
3. Sensitivity analysis (i.e. management)
